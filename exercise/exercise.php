...
<html>
  ...
  <body>
    ...
    <header>
      ...
      <a href="../main/main.html"><img id="logo" src="../img/turtleneck_logo.svg" alt="logo"></a> <!--아직 마이페이지 없으니까 calender로 대체할게 -->
      <!-- 로그아웃 -->
  ...
  <script>
    ...
    function go_complete() {
      ...
      //window.open("../complete.php", "complete", 'width=500, height=250, scrollbars=no');
    }
