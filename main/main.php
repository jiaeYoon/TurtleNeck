...
<body>
  ...
  <script>
    ...
    function createBtn(num, eng, name, expl, image, hashtags) {
      const contents_btn = document.createElement('div');
      contents_btn.setAttribute('onClick', `document.forms['form${num}'].submit();`);
      
      const contents_form = document.createElement('form');
      contents_form.setAttribute('action', '../exercise/exercise.php');
      contents_form.setAttribute('method', 'GET');
      contents_form.setAttribute('class', 'contents__btn');
      contents_form.setAttribute('id', `${eng}`);
      contents_form.setAttribute('name', `form${num}`);
      ...
      contents_form.appendChild(contents_input);
      ...
      contents_form.appendChild(contents_image);
      ...
      contents_form.appendChild(contents_text);
      contents_btn.appendChild(contents_form);
